...
Архивы будут зашифрованы с использованием алгоритма AES-256. Обратите внимание, что открыть такие архивы можно только программами, поддерживающими расшифровку ZIP архивов с AES шифрованием (например, 7-Zip или WinRAR). 
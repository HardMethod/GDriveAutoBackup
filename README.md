...
- Защита архивов паролем (единый пароль для общего архива)
...
Для использования защиты архивов паролем:
...
2. Укажите пароль в файле `.env`:
```
ARCHIVE_PASSWORD=ваш_надежный_пароль
```

Система создаст один общий защищенный архив, содержащий все файлы бэкапов (сайт и база данных). Архив будет зашифрован с использованием алгоритма AES-256. Обратите внимание, что открыть такие архивы можно только программами, поддерживающими расшифровку ZIP архивов с AES шифрованием (например, 7-Zip или WinRAR). 